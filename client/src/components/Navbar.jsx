  ...
  return (
    <header className="container flex justify-between items-center h-16">
      <NavLink to="/" className="flex items-center justify-center gap-1">
        ...
        <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 font-semibold text-xl">
          BLOGIFY
        </span>
      </NavLink>
      <nav>
        {user ? (
          ...
          <NavLink to="/login">
            <button className="py-3 px-4 inline-flex items-center gap-x-2 text-md font-semibold rounded-lg border border-transparent text-teal-500 hover:bg-teal-100 hover:text-teal-800 disabled:opacity-50 disabled:pointer-events-none 0">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
